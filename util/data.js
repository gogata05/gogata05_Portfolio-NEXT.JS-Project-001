...
export const data = {
  details: [
    {
      name: "Georgi Markov",
      linkedin: "https://www.linkedin.com/in/georgi-markov-57b5b224b/",
      github: "https://github.com/gogata05"
    }
  ],
  navigation: [
...
export const educationData = [
  ...
  },
  {
    ...
    location: "Software University",
    text: "Advanced algorithms in C#, including sorting, searching, and graph algorithms.",
    delay: 0.4,
    icons: ["icons/csharp.svg"],
    githubLink: "https://github.com/gogata05/CSharp-Algorithms-Advanced"
  },
...
export const workExperienceData = [
  {
    ...
    details: "Fast Coding Expert. Using AI tools(Cursor,Windsurf,Agents,MCP,Claude,V0 and more) to code custom client projects to cut the production time from months into weeks, with high quality.\nNo team needed. One man army developer.",
    features: [".NET", "React", "MS SQL", "Tailwind CSS", "Vue.js", "Supabase"],
    team: ["Georgi Markov"],
